...
var rp11 = {
    rpas: undefined,
    DTYPE: [0o20022, 0o20022, 0o20020, 0o20020, 0o20022, 0o20020, 0o20022, 0o20042],
    SECTORS: [22, 22, 22, 22, 22, 22, 22, 50],
    ...
    rpcs2: 0,
    rpds: [0x1180, 0x1180, 0x1180, 0x1180, 0, 0, 0, 0],
    rper1: [0, 0, 0, 0, 0, 0, 0, 0],
    // rpas: 0, // Massbus 04???
    rpla: [0, 0, 0, 0, 0, 0, 0, 0],
    rpdb: 0,
    rpmr: [0, 0, 0, 0, 0, 0, 0, 0],
    rpdt: [0, 0, 0, 0, 0, 0, 0, 0],
    rpsn: [1, 2, 3, 4, 5, 6, 7, 8],
    rpof: [0, 0, 0, 0, 0, 0, 0, 0],
    rpdc: [0, 0, 0, 0, 0, 0, 0, 0],
    rpcc: [0, 0, 0, 0, 0, 0, 0, 0],
    rper2: [0, 0, 0, 0, 0, 0, 0, 0],
    rper3: [0, 0, 0, 0, 0, 0, 0, 0],
    rpec1: [0, 0, 0, 0, 0, 0, 0, 0],
    rpec2: [0, 0, 0, 0, 0, 0, 0, 0],
    rpcs3: 0
};
function rp11_init() {
    rp11.rpcs1 = 0x880;
        ...
        case 0o17776700: // rp11.rpcs1 Control status 1
            ...
            if (data >= 0) {
                ...
                if (result >= 0) {
                    ...
                    if (!(result & 0x40))
                        interrupt(1, -1, 0, 0o254); //remove pending interrupt if IE not set
                    if ((data & 0xc0) == 0xc0)
                        interrupt(1, 8, 5 << 5, 0o254); // RB:
                    rp11.rpcs1 = result;
...
//# sourceMappingURL=iopage.js.map